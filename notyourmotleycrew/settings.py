...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'read_default_file': '/home/oivvio/notyourmotleycrewdb2.cnf',
        },
    }
}
...
SECRET_KEY = 'u23+t(v@=9g5vm7&amp;wq=^lquc2toq*=!@*6@#*d#@&amp;h0fzdd#ql'
...
ROOT_URLCONF = 'notyourmotleycrew.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'notyourmotleycrew.wsgi.application'
