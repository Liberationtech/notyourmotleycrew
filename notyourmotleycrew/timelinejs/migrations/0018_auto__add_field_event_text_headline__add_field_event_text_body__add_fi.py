...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.text_headline'
        db.add_column('timelinejs_event', 'text_headline',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.text_body'
        db.add_column('timelinejs_event', 'text_body',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.text_byline'
        db.add_column('timelinejs_event', 'text_byline',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.text_headline'
        db.delete_column('timelinejs_event', 'text_headline')

        # Deleting field 'Event.text_body'
        db.delete_column('timelinejs_event', 'text_body')

        # Deleting field 'Event.text_byline'
        db.delete_column('timelinejs_event', 'text_byline')
    ...
    models = {
        ...
        'timelinejs.event': {
            ...
            'html_raw': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'text_byline': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'text_headline': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'timelinejs.outlet': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'selector_body': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'selector_byline': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'selector_headline': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        'timelinejs.timeline': {
