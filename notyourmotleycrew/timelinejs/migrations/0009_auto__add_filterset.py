...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('timelinejs_filterset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('timelinejs', ['Filterset'])

        # Adding M2M table for field filtersets on 'Event'
        db.create_table('timelinejs_event_filtersets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm['timelinejs.event'], null=False)),
            ('filterset', models.ForeignKey(orm['timelinejs.filterset'], null=False))
        ))
        db.create_unique('timelinejs_event_filtersets', ['event_id', 'filterset_id'])


    def backwards(self, orm):
        # Deleting model 'Filterset'
        db.delete_table('timelinejs_filterset')

        # Removing M2M table for field filtersets on 'Event'
        db.delete_table('timelinejs_event_filtersets')
    ...
    models = {
        ...
        'timelinejs.event': {
            ...
            'filtersets': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['timelinejs.Filterset']", 'symmetrical': 'False'}),
