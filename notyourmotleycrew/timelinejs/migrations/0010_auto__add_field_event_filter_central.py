...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.filter_central'
        db.add_column('timelinejs_event', 'filter_central',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.filter_central'
        db.delete_column('timelinejs_event', 'filter_central')
