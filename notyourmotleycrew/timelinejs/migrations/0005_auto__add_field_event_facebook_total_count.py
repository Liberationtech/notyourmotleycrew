...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.facebook_total_count'
        db.add_column('timelinejs_event', 'facebook_total_count',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.facebook_total_count'
        db.delete_column('timelinejs_event', 'facebook_total_count')
