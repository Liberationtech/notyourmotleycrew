...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Outlet.selector_headline'
        db.add_column('timelinejs_outlet', 'selector_headline',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Outlet.selector_headline'
        db.delete_column('timelinejs_outlet', 'selector_headline')
