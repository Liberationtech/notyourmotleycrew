...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Outlet.selector_body'
        db.add_column('timelinejs_outlet', 'selector_body',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Outlet.selector_byline'
        db.add_column('timelinejs_outlet', 'selector_byline',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Outlet.selector_body'
        db.delete_column('timelinejs_outlet', 'selector_body')

        # Deleting field 'Outlet.selector_byline'
        db.delete_column('timelinejs_outlet', 'selector_byline')
    ...
    models = {
        ...
        'timelinejs.outlet': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'selector_body': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True'}),
            'selector_byline': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True'}),
            'selector_headline': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True'})
        },
        'timelinejs.timeline': {
