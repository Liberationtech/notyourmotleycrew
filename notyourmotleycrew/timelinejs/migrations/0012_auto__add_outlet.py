...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('timelinejs_outlet', (
            ...
            ('outlet', self.gf('django.db.models.fields.related.ForeignKey')(related_name='outlet', to=orm['timelinejs.Event'])),
        ))
    ...
    models = {
        ...
        'timelinejs.outlet': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'outlet': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'outlet'", 'to': "orm['timelinejs.Event']"})
        },
        'timelinejs.timeline': {
